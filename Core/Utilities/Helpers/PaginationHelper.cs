...
namespace Core.Utilities.Helpers
{
    ...
    {
        public static PagedResult<List<T>> CreatePagedResponse<T>(List<T> pagedData, PaginationFilter validFilter,
            int totalRecords, IUriService uriService, string route)
        {
            var response = new PagedResult<List<T>>(pagedData, validFilter.PageNumber, validFilter.PageSize);
